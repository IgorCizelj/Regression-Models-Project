...
Start with the predictor whose correlation with mpg is highest (wt);
Eliminate from the model variables that are highly correlated with wt;
Add the remaining predictor, qsec, which is nearly orthogonal to wt; and
Add our variable of interest, am, to see if it is a significant predictor.
